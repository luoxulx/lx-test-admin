...
const toolbar = ['bold italic underline strikethrough alignleft aligncenter alignright outdent indent  blockquote undo redo removeformat subscript superscript code codesample hr bullist numlist link unlink anchor pagebreak spellchecker insertdatetime preview print', 'charmap table quickimage image media emoticons forecolor backcolor fullscreen help']
